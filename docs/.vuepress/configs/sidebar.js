import { sidebarList } from '../utils/index.js'
export const sidebar = {
  ...
  '/frontend/webpack5/': sidebarList('/frontend/webpack5'),
  ...
  '/tools/others': sidebarList('/tools/others'),
  '/tools/npm': sidebarList('/tools/npm'),
  '/interview/': sidebarList('/interview')
}
