import{_ as n,c as s,o as e,d as a}from"./app-DCPYa7PH.js";const i={},l=a(`<h2 id="第12课-常用数据结构之字典" tabindex="-1"><a class="header-anchor" href="#第12课-常用数据结构之字典"><span>第12课：常用数据结构之字典</span></a></h2><p>迄今为止，我们已经为大家介绍了Python中的三种容器型数据类型，但是这些数据类型仍然不足以帮助我们解决所有的问题。例如，我们要保存一个人的信息，包括姓名、年龄、体重、单位地址、家庭住址、本人手机号、紧急联系人手机号等信息，你会发现我们之前学过的列表、元组和集合都不是最理想的选择。</p><div class="language-Python line-numbers-mode" data-highlighter="prismjs" data-ext="Python" data-title="Python"><pre class="language-Python"><code><span class="line">person1 = [&#39;王大锤&#39;, 55, 60, &#39;科华北路62号&#39;, &#39;中同仁路8号&#39;, &#39;13122334455&#39;, &#39;13800998877&#39;]</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="简单的总结" tabindex="-1"><a class="header-anchor" href="#简单的总结"><span>简单的总结</span></a></h3><p>Python程序中的字典跟现实生活中字典非常像，允许我们<strong>以键值对的形式保存数据</strong>，再<strong>通过键索引对应的值</strong>。这是一种非常<strong>有利于数据检索</strong>的数据类型，底层原理我们在后续的课程中为大家讲解。再次提醒大家注意，<strong>字典中的键必须是不可变类型</strong>，字典中的值可以是任意类型。</p>`,33),d=[l];function p(c,r){return e(),s("div",null,d)}const v=n(i,[["render",p],["__file","第12课：常用数据结构之字典.html.vue"]]),u=JSON.parse('{"path":"/python/Python-Core-50-Courses/%E7%AC%AC12%E8%AF%BE%EF%BC%9A%E5%B8%B8%E7%94%A8%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84%E4%B9%8B%E5%AD%97%E5%85%B8.html","title":"","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"第12课：常用数据结构之字典","slug":"第12课-常用数据结构之字典","link":"#第12课-常用数据结构之字典","children":[{"level":3,"title":"创建和使用字典","slug":"创建和使用字典","link":"#创建和使用字典","children":[]},{"level":3,"title":"字典的运算","slug":"字典的运算","link":"#字典的运算","children":[]},{"level":3,"title":"字典的方法","slug":"字典的方法","link":"#字典的方法","children":[]},{"level":3,"title":"字典的应用","slug":"字典的应用","link":"#字典的应用","children":[]},{"level":3,"title":"简单的总结","slug":"简单的总结","link":"#简单的总结","children":[]}]}],"git":{"updatedTime":1720435246000,"contributors":[{"name":"linannan","email":"linannan@prosnav.com","commits":1}]},"filePathRelative":"python/Python-Core-50-Courses/第12课：常用数据结构之字典.md"}');export{v as comp,u as data};
