import{_ as n,c as s,o as e,e as a}from"./app-B7BTqdne.js";const i="/docs/assets/int-is-comparation-BoDpVXdd.png",l="/docs/assets/result-of-dis-DMMKBI9M.png",d="/docs/assets/python-tutor-visualize-BXFIWNjw.png",c="/docs/assets/python-tutor-visualize2-Ba9G-IQa.png",t={},p=a(`<h2 id="那些年我们踩过的那些坑" tabindex="-1"><a class="header-anchor" href="#那些年我们踩过的那些坑"><span>那些年我们踩过的那些坑</span></a></h2><h3 id="坑1-整数比较的坑" tabindex="-1"><a class="header-anchor" href="#坑1-整数比较的坑"><span>坑1 - 整数比较的坑</span></a></h3><p>在 Python 中一切都是对象，整数也是对象，在比较两个整数时有两个运算符<code>==</code>和<code>is</code>，它们的区别是：</p><ul><li><code>is</code>比较的是两个整数对象的id值是否相等，也就是比较两个引用是否代表了内存中同一个地址。</li><li><code>==</code>比较的是两个整数对象的内容是否相等，使用<code>==</code>时其实是调用了对象的<code>__eq__()</code>方法。</li></ul><p>知道了<code>is</code>和<code>==</code>的区别之后，我们可以来看看下面的代码，了解Python中整数比较有哪些坑，<strong>以CPython解释器为例</strong>，大家先看看下面的代码。</p><div class="language-Python line-numbers-mode" data-highlighter="prismjs" data-ext="Python" data-title="Python"><pre class="language-Python"><code><span class="line">def main():</span>
