import{_ as s,c as n,o as e,d as a}from"./app-BFPhRmaa.js";const i="/docs/assets/pivot_table_1-CLrHJV73.png",l="/docs/assets/pivot_table_2-DCvQpUYO.png",d="/docs/assets/sales_bar_graph-Lx75m3uJ.png",t="/docs/assets/sales_pie_graph-DZJVXXT3.png",c={},p=a(`<h2 id="深入浅出pandas-4" tabindex="-1"><a class="header-anchor" href="#深入浅出pandas-4"><span>深入浅出pandas-4</span></a></h2><h3 id="数据透视" tabindex="-1"><a class="header-anchor" href="#数据透视"><span>数据透视</span></a></h3><p>经过前面的学习，我们已经将数据准备就绪而且变成了我们想要的样子，接下来就是最为重要的数据透视阶段了。当我们拿到一大堆数据的时候，如何从数据中迅速的解读出有价值的信息，把繁杂的数据变成容易解读的统计图表并再此基础上产生业务洞察，这就是数据分析要解决的核心问题。</p><h4 id="获取描述性统计信息" tabindex="-1"><a class="header-anchor" href="#获取描述性统计信息"><span>获取描述性统计信息</span></a></h4><p>首先，我们可以获取数据的描述性统计信息，通过描述性统计信息，我们可以了解数据的集中趋势和离散趋势。</p><p>例如，我们有如下所示的学生成绩表。</p><div class="language-Python line-numbers-mode" data-highlighter="prismjs" data-ext="Python" data-title="Python"><pre class="language-Python"><code><span class="line">scores = np.random.randint(50, 101, (5, 3))</span>
