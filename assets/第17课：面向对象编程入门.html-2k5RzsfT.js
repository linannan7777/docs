...
<span class="line">        print(f&#39;{self.name}正在学习{course_name}.&#39;)</span>
<span class="line"></span>
<span class="line">    def play(self):</span>
<span class="line">        &quot;&quot;&quot;玩耍&quot;&quot;&quot;</span>
<span class="line">        print(f&#39;{self.name}正在玩游戏.&#39;)</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改刚才创建对象和给对象发消息的代码，重新执行一次，看看程序的执行结果有什么变化。</p><div class="language-Python line-numbers-mode" data-highlighter="prismjs" data-ext="Python" data-title="Python"><pre class="language-Python"><code><span class="line"># 由于初始化方法除了self之外还有两个参数</span>
<span class="line"># 所以调用Student类的构造器创建对象时要传入这两个参数</span>
<span class="line">stu1 = Student(&#39;骆昊&#39;, 40)</span>
<span class="line">stu2 = Student(&#39;王大锤&#39;, 15)</span>
<span class="line">stu1.study(&#39;Python程序设计&#39;)    # 骆昊正在学习Python程序设计.</span>
<span class="line">stu2.play()                    # 王大锤正在玩游戏.</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="打印对象" tabindex="-1"><a class="header-anchor" href="#打印对象"><span>打印对象</span></a></h3><p>上面我们通过<code>__init__</code>方法在创建对象时为对象绑定了属性并赋予了初始值。在Python中，以两个下划线<code>__</code>（读作“dunder”）开头和结尾的方法通常都是有特殊用途和意义的方法，我们一般称之为<strong>魔术方法</strong>或<strong>魔法方法</strong>。如果我们在打印对象的时候不希望看到对象的地址而是看到我们自定义的信息，可以通过在类中放置<code>__repr__</code>魔术方法来做到，该方法返回的字符串就是用<code>print</code>函数打印对象的时候会显示的内容，代码如下所示。</p><div class="language-Python line-numbers-mode" data-highlighter="prismjs" data-ext="Python" data-title="Python"><pre class="language-Python"><code><span class="line">class Student:</span>
<span class="line">    &quot;&quot;&quot;学生&quot;&quot;&quot;</span>
<span class="line"></span>
<span class="line">    def __init__(self, name, age):</span>
<span class="line">        &quot;&quot;&quot;初始化方法&quot;&quot;&quot;</span>
...
<span class="line">        &quot;&quot;&quot;</span>
<span class="line">        self.hour = hour</span>
<span class="line">        self.min = minute</span>
<span class="line">        self.sec = second</span>
<span class="line"></span>
<span class="line">    def run(self):</span>
<span class="line">        &quot;&quot;&quot;走字&quot;&quot;&quot;</span>
<span class="line">        self.sec += 1</span>
<span class="line">        if self.sec == 60:</span>
<span class="line">            self.sec = 0</span>
<span class="line">            self.min += 1</span>
<span class="line">            if self.min == 60:</span>
<span class="line">                self.min = 0</span>
<span class="line">                self.hour += 1</span>
<span class="line">                if self.hour == 24:</span>
<span class="line">                    self.hour = 0</span>
<span class="line"></span>
<span class="line">    def show(self):</span>
<span class="line">        &quot;&quot;&quot;显示时间&quot;&quot;&quot;</span>
<span class="line">        return f&#39;{self.hour:0&gt;2d}:{self.min:0&gt;2d}:{self.sec:0&gt;2d}&#39;</span>
<span class="line"></span>
<span class="line"></span>
<span class="line"># 创建时钟对象</span>
<span class="line">clock = Clock(23, 59, 58)</span>
<span class="line">while True:</span>
<span class="line">    # 给时钟对象发消息读取时间</span>
<span class="line">    print(clock.show())</span>
<span class="line">    # 休眠1秒钟</span>
<span class="line">    time.sleep(1)</span>
<span class="line">    # 给时钟对象发消息使其走字</span>
<span class="line">    clock.run()</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="案例2-定义一个类描述平面上的点-要求提供计算到另一个点距离的方法。" tabindex="-1"><a class="header-anchor" href="#案例2-定义一个类描述平面上的点-要求提供计算到另一个点距离的方法。"><span>案例2：定义一个类描述平面上的点，要求提供计算到另一个点距离的方法。</span></a></h4><div class="language-Python line-numbers-mode" data-highlighter="prismjs" data-ext="Python" data-title="Python"><pre class="language-Python"><code><span class="line">class Point(object):</span>
<span class="line">    &quot;&quot;&quot;屏面上的点&quot;&quot;&quot;</span>
<span class="line"></span>
...
<span class="line">        &quot;&quot;&quot;</span>
<span class="line">        self.x, self.y = x, y</span>
<span class="line"></span>
...
<span class="line">        return (dx * dx + dy * dy) ** 0.5</span>
<span class="line"></span>
<span class="line">    def __str__(self):</span>
<span class="line">        return f&#39;({self.x}, {self.y})&#39;</span>
<span class="line"></span>
<span class="line"></span>
<span class="line">p1 = Point(3, 5)</span>
<span class="line">p2 = Point(6, 9)</span>
<span class="line">print(p1, p2)</span>
<span class="line">print(p1.distance_to(p2))</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="简单的总结" tabindex="-1"><a class="header-anchor" href="#简单的总结"><span>简单的总结</span></a></h3><p>面向对象编程是一种非常流行的编程范式，除此之外还有<strong>指令式编程</strong>、<strong>函数式编程</strong>等编程范式。由于现实世界是由对象构成的，而对象是可以接收消息的实体，所以<strong>面向对象编程更符合人类正常的思维习惯</strong>。类是抽象的，对象是具体的，有了类就能创建对象，有了对象就可以接收消息，这就是面向对象编程的基础。定义类的过程是一个抽象的过程，找到对象公共的属性属于数据抽象，找到对象公共的方法属于行为抽象。抽象的过程是一个仁者见仁智者见智的过程，对同一类对象进行抽象可能会得到不同的结果，如下图所示。</p><img src="`+i+'" width="75%"><blockquote><p><strong>说明：</strong> 本节课的插图来自于 Grady Booc 等撰写的《面向对象分析与设计》一书，该书是讲解面向对象编程的经典著作，有兴趣的读者可以购买和阅读这本书来了解更多的面向对象的相关知识。</p></blockquote>',44),c=[t];function p(r,o){return e(),n("div",null,c)}const v=s(d,[["render",p],["__file","第17课：面向对象编程入门.html.vue"]]),m=JSON.parse('{"path":"/python/Python-Core-50-Courses/%E7%AC%AC17%E8%AF%BE%EF%BC%9A%E9%9D%A2%E5%90%91%E5%AF%B9%E8%B1%A1%E7%BC%96%E7%A8%8B%E5%85%A5%E9%97%A8.html","title":"","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"第17课：面向对象编程入门","slug":"第17课-面向对象编程入门","link":"#第17课-面向对象编程入门","children":[{"level":3,"title":"类和对象","slug":"类和对象","link":"#类和对象","children":[]},{"level":3,"title":"定义类","slug":"定义类","link":"#定义类","children":[]},{"level":3,"title":"创建和使用对象","slug":"创建和使用对象","link":"#创建和使用对象","children":[]},{"level":3,"title":"初始化方法","slug":"初始化方法","link":"#初始化方法","children":[]},{"level":3,"title":"打印对象","slug":"打印对象","link":"#打印对象","children":[]},{"level":3,"title":"面向对象的支柱","slug":"面向对象的支柱","link":"#面向对象的支柱","children":[]},{"level":3,"title":"经典案例","slug":"经典案例","link":"#经典案例","children":[]},{"level":3,"title":"简单的总结","slug":"简单的总结","link":"#简单的总结","children":[]}]}],"git":{"updatedTime":1720516588000,"contributors":[{"name":"linannan","email":"linannan@prosnav.com","commits":2}]},"filePathRelative":"python/Python-Core-50-Courses/第17课：面向对象编程入门.md"}');export{v as comp,m as data};
