...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p><strong>说明</strong>：上面配置文件中的<code>ITEM_PIPELINES</code>选项是一个字典，可以配置多个处理数据的管道，后面的数字代表了执行的优先级，数字小的先执行。</p></blockquote></li></ol>`,24),c=[l];function d(p,r){return n(),e("div",null,c)}const o=s(i,[["render",d],["__file","第39课：爬虫框架Scrapy简介.html.vue"]]),v=JSON.parse('{"path":"/python/Python-Core-50-Courses/%E7%AC%AC39%E8%AF%BE%EF%BC%9A%E7%88%AC%E8%99%AB%E6%A1%86%E6%9E%B6Scrapy%E7%AE%80%E4%BB%8B.html","title":"","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"第39课：爬虫框架Scrapy简介","slug":"第39课-爬虫框架scrapy简介","link":"#第39课-爬虫框架scrapy简介","children":[{"level":3,"title":"Scrapy 概述","slug":"scrapy-概述","link":"#scrapy-概述","children":[]},{"level":3,"title":"安装和使用Scrapy","slug":"安装和使用scrapy","link":"#安装和使用scrapy","children":[]}]}],"git":{"updatedTime":1720435246000,"contributors":[{"name":"linannan","email":"linannan@prosnav.com","commits":1}]},"filePathRelative":"python/Python-Core-50-Courses/第39课：爬虫框架Scrapy简介.md"}');export{o as comp,v as data};
