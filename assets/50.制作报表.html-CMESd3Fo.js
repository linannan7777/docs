import{_ as s,c as n,o as e,b as a}from"./app-CstveDQQ.js";const l="/docs/assets/echarts_bar_graph-Dkh-qZxP.png",i={},t=a(`<h2 id="制作报表" tabindex="-1"><a class="header-anchor" href="#制作报表"><span>制作报表</span></a></h2><h3 id="导出excel报表" tabindex="-1"><a class="header-anchor" href="#导出excel报表"><span>导出Excel报表</span></a></h3><p>报表就是用表格、图表等格式来动态显示数据，所以有人用这样的公式来描述报表：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">报表 = 多样的格式 + 动态的数据</span>
